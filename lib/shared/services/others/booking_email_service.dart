...
class BookingEmailService {
    ...
    switch (languageCode) {
      case 'en':
        return {
          ...
          'doctor_message': 'A new appointment has been booked with you successfully.',
          'patient_label': 'Patient Name:',
          'date_label': 'Date:',
          'time_label': 'Time:',
          'booking_id_label': 'Booking ID:',
          'doctor_footer_message': 'You can view the appointment details through the app.',
          'doctor_note': 'Please make sure to be present at the scheduled time.',
          'patient_subject': 'Appointment Confirmation - Estaraht',
          'patient_title': '✓ Appointment Confirmed',
          'patient_greeting': 'Hello',
          'patient_message': 'Your appointment has been confirmed successfully.',
          'doctor_label': 'Therapist:',
          'patient_footer_message': 'The session link will be sent before the scheduled time.',
      ...
      case 'fr':
        return {
          ...
          'doctor_message': 'Un nouveau rendez-vous a été réservé avec vous avec succès.',
          'patient_label': 'Nom du Patient:',
          'date_label': 'Date:',
          'time_label': 'Heure:',
          'booking_id_label': 'ID de Réservation:',
          'doctor_footer_message': 'Vous pouvez consulter les détails du rendez-vous via l\'application.',
          'doctor_note': 'Veuillez vous assurer d\'être présent à l\'heure prévue.',
          ...
          'patient_footer_message': 'Le lien de la séance sera envoyé avant l\'heure prévue.',
      ...
      default: // Arabic
        return {
          ...
          'doctor_footer_message': 'يمكنك الاطلاع على تفاصيل الجلسة من خلال التطبيق.',
          ...
          'patient_footer_message': 'سيتم إرسال رابط الجلسة قبل الموعد المحدد.',
  ...
  static Future<bool> sendDoctorEmail({
    ...
    final lang = isRTL ? 'ar' : languageCode;
...
<body>
  <div class="container">
    ...
    <div class="content">
      <p>${content['doctor_greeting']} $doctorName،</p>
    ...
    <div class="footer">
      ...
      <p>© ${TimezoneService.getCurrentMauritaniaTime().year} Estaraht. ${content['rights']}</p>
    </div>
  </div>
</body>
</html>
...
<body>
  <div class="container">
    ...
    <div class="content">
      <p>${content['patient_greeting']} $patientName،</p>
      <p>${content['patient_message']}</p>

      <div class="info-box">
        <div class="info-row">
          <span class="label">${content['doctor_label']}</span>
          <span class="value">د. $doctorName</span>
        </div>
        <div class="info-row">
          <span class="label">${content['date_label']}</span>
          <span class="value">$formattedDate</span>
