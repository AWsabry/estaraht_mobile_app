...
import 'package:videocalling/core/constants/app_urls.dart';
        ...
        Padding(
          ...
          child: Column(
            children: [
              ...
              // Privacy Policy
              _buildSettingsItem(
                svgIcon: AppImages.aboutUsIcon,
                title: 'privacy_policy'.tr,
                onTap: () => infoController.openUrl(AppUrls.privacyPolicy),
              ),

              // Delete account
              _buildSettingsItem(
                svgIcon: AppImages.deleteIconSvg,
