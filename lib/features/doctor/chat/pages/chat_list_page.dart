...
class ChatListScreen extends GetView<DoctorChatListController> {
  final DoctorChatListController chatListController = Get.put(
              ...
              ? chatListController.chatListDetails.isEmpty
                    ...
                    : MediaQuery.removePadding(
                        ...
                        child: ListView.builder(
                          itemCount: chatListController.chatListDetails.length,
                                ...
                                return Card(
                                  ...
                                  child: Container(
                                    ...
                                    child: ListTile(
                                        ...
                                        children: [
                                          chatListController
                                              ...
                                              : Container(
                                                  ...
                                                  width: 23,
                                                  child: Center(
                                                    child: AppTextWidgets.blackTextWithColor(
                                      ...
                                      subtitle: chatListController.typeToWidget(
                                        chatListController
                                            .chatListDetails[index]
                                            .type,
                                        chatListController
