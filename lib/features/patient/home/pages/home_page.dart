  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        toolbarHeight: kToolbarHeight + 325,
        flexibleSpace: CustomHomeScreenAppBar(
          ...
          onPressed: () async {
            ...
            await Get.toNamed(
              ...
              arguments: {
                'keyword': homeController.textController.text,
                'category': '',
                'categoryIndex': 0,
              },
            );
                  ...
                  if (homeController.isErrorInLoadDoctorData.value) {
                    ...
                    return Column(
                      children: [
                        ...
                        SizedBox(
                          height: 272, // Fixed height for card container
                          child: Obx(() {
